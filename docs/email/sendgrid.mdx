...
notifications through your SendGrid account, no other action is needed. You will
...
Check [SendGrid's Web API](https://docs.sendgrid.com/api-reference/mail-send/mail-send) for a
comprehensive list of allowed parameters. Below you can see how to send an email
notification with custom headers.
...
"notification": {
  ...
  "overrides": {
    "providers": {
      "sendgrid": {
        "headers": {
          "X-Delivered-To": "dan@example.com"
        }
      }
    }
  }
