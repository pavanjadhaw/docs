...
<Note>
  Be sure to replace <pre className="inline">MAGICBELL_API_KEY</pre> with your project's
  API key. Keep your API secret safe, do not initialize the notification inbox with it.
</Note>
