...
The way you send notifications to a user depends on how you identify users in your app. MagicBell accepts emails and external IDs (strings) as unique identifiers for users.
