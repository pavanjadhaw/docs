...
<Note>
  Be sure to replace <pre className="inline">MAGICBELL_API_KEY</pre> and{' '}
  <pre className="inline">MAGICBELL_API_SECRET</pre> with your actual API key and API
  secret before running the following examples.
</Note>
