...
Josue - MagicBell's CTO - [wrote a great tutorial on how to build MagicBell using Angular](https://magicbell.com/blog/building-a-notification-system-in-angular).
