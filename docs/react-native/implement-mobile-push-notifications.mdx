...
<br />
MagicBell needs the p8 key, its ID, the team ID for your Apple account and the bundle ID of
your iOS app. Please [contact us](mailto:hello@magicbell.io) so we can help you set them up
for your account.
...
MagicBell needs the project's server key and sender ID, and the bundle ID of your Android app.
Please [contact us](mailto:hello@magicbell.io) so we can help you set them up for your account.
...
However, you still need to setup your app.

If you are developing your app with [Expo](https://expo.io) or any other [React Native](https://reactnative.dev/) library we recommend to use
[this React Native library](https://github.com/zo0r/react-native-push-notification). This is a short example:
...
You might also find helpful to read the [full React Native example](https://github.com/magicbell-io/react-native-notifications-example) we created.
