...
Our [`@magicbell/react-headless`](https://www.npmjs.com/package/@magicbell/react-headless) package contains components and hooks that will help you create a notification inbox for your React Native app.
...
Notice that this component is wrapped with the `observer` function to automatically update notifications in real-time.
