...
When creating a notification, you can set a category for it in the
`notification.category` parameter. A category must contain less than 256
characters and it should not contain spaces.
...
fewer channels, we can enable that for you. Please write to us.
