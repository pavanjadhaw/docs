...
To select the default channels for all notifications across an entire project, navigate to the Channels page on the sidebar. 

<img className="full-mobile" src="/docs/uploads/Channels.png" style={{ width: "80%", height: 'intrinsic' }} />

### Users of Your Application

Users can control the channels they receive notification to by using the setting preferences. By clicking the gear icon, each user can control which channels notifications are sent to for each category.
